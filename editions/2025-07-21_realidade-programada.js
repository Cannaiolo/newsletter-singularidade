export default {
  sumario: [
    "Mercado de criptomoedas atinge US$ 4 trilhões após aprovação do GENIUS Act",
    "Startup de IA de Mira Murati arrecada US$ 2 bi com avaliação de US$ 12 bi",
    "China aprova pacote de estímulo de US$ 500 bi para indústria de chips",
    "Plataforma usa IA para reduzir comissões no mercado imobiliário dos EUA",
    "Tendências em redes sociais que moldam o marketing imobiliário"
  ],
  blocos: [
    {
    ...
    },
    {
      ...
      resumo:
        "Robô com tema de desenho animado, totalmente carregado com suprimentos para lojas 7-Eleven, conclui sua primeira entrega autônoma na Estação Wanxia da Linha 2 do Metrô de Shenzhen.",
    ...
    },
    {
      ...
      resumo:
        "Segundo o Realtor.com, vídeos curtos, ferramentas de IA generativa e personalização dinâmica são as principais forças que transformam o marketing de imóveis, ajudando corretores a engajar públicos mais jovens e ampliar alcance digital.",
      link: "https://www.realtor.com/marketing/resources/social-media-trends-shaping-the-future-of-real-estate-marketing/"
    }
  ]
};
